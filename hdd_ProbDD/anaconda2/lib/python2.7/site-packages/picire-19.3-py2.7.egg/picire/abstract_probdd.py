...
class AbstractProbDD(object):
    ...
    def __init__(self, test, split, cache=None, id_prefix=(), shuffle=False, onepass=False, counter=0, no_sort_before_sample=False, use_ddmin_in_probdd=False, complement_only_in_probdd=False, use_counter_in_probdd=False):
        """
